...
{
	this->SetSizeHints( wxSize( 520,600 ), wxDefaultSize );
	...
	m_staticText11 = new wxStaticText( m_panel1, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizer4->Add( m_grid3, 0, 0, 5 );


	bSizer9->Add( bSizer4, 1, wxALIGN_CENTER|wxALL, 5 );
